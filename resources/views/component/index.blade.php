    ...
    <x-slot name="header">
        <div class="flex">
            ...
            <div class="w-1/2 text-right">
                <a href="{{url('/component/create')}}" class="text-white px-5 py-3 bg-gray-600">
                    Create New
                </a>
            </div>
        </div>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <table class="min-w-max w-full table-auto table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="py-5">{{$component->id}}</td>
                                <td class="py-5">{{$component->name}}</td>
                                <td class="py-5">
                                    <div class="flex">
                                        <a href="{{route('component.edit',['component'=>$component->id])}}">
                                        ...
                                        <form method="POST" action="{{route('component.destroy',['component'=>$component->id])}}">
                                            @csrf
                                            @method('delete')
                                            <button type="submit">
